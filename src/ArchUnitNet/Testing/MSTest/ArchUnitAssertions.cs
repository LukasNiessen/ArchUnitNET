...
namespace ArchUnitNet.Testing.MSTest;

/// <summary>
/// MSTest-native extension methods for architecture assertions.
/// Integrates with MSTest's Assert API.
/// </summary>
...
/// <summary>
/// Fluent MSTest assertions using method chaining.
